  ...
  render() {
    return (
      <View style={[styles.container]}>
        <Text style={[styles.label, { fontFamily: 'Courier' }]}>
          {this.state.day}
        </Text>
        <TextInput
          ...
          onEndEditing={() => this.TimeCalculate()}
          placeholder="hh"
        ...
        <TextInput
          ...
          onChangeText={value =>
            (value =
              value > 59
                ? this.setState({ startM: '59' })
                : this.setState({ startM: value }) || value < 0
                ? this.setState({ startM: '0' })
                : this.setState({ startM: value }))
          }
          onEndEditing={() => this.TimeCalculate()}
          placeholder="mm"
          keyboardType="number-pad"
        ...
        <TextInput
          ...
          onChangeText={value =>
            (value =
              value > 59
                ? this.setState({ endM: '59' })
                : this.setState({ endM: value }) || value < 0
                ? this.setState({ endM: '0' })
                : this.setState({ endM: value }))
          }
          onEndEditing={() => this.TimeCalculate()}
          placeholder="mm"
          keyboardType="number-pad"
